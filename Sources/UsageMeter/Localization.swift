...
enum Loc {
    ...
    static let table: [String: (String, String, String)] = [
        ...
        "update.available":   ("새 버전 %@ 있음", "Version %@ available", "新バージョン %@ あり"),
        "update.openPage":    ("릴리스 페이지 열기", "Open Releases Page", "リリースページを開く"),
        "update.download":    ("최신 버전 내려받기", "Download Latest", "最新版をダウンロード"),
        "update.downloading": ("내려받는 중…", "Downloading…", "ダウンロード中…"),
        "update.downloaded":  ("내려받기 완료 — Finder에서 보기", "Downloaded — Show in Finder", "ダウンロード完了 — Finderで表示"),
        "update.downloadFail":("내려받기 실패 — 릴리스 페이지 열기", "Download failed — Open Releases Page", "ダウンロード失敗 — リリースページを開く"),
        "update.installHint": ("받은 zip을 풀어 응용 프로그램 폴더로 옮기면 설치됩니다.", "Unzip the downloaded file and move it to Applications to install.", "ダウンロードしたzipを展開し、アプリケーションフォルダに移動すればインストールされます。"),
